...
[RequireComponent(typeof(ClickModelP1))]
public class P1HighLightConfig : MonoBehaviour
{
    Button3D button3D;
    ClickModelP1 clickModel;
    ...
    void Start()
    {
        ...
        clickModel = gameObject.GetComponent<ClickModelP1>();
