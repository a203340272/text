...
[RequireComponent(typeof(ClickModelB1))]
public class B1HighLightConfig : MonoBehaviour
{
    Button3D button3D;
    ClickModelB1 clickModel;
    ...
    void Start()
    {
        ...
        clickModel = gameObject.GetComponent<ClickModelB1>();
